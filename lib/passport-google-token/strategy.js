 ...
 * @api protected
 */
GoogleTokenStrategy.prototype.authenticate = function(req, options) { console.log(req.query, req.body);
  options = options || {};
  var self = this;
  ...
  var accessToken =
    ...
    req.headers && req.headers['access_token'];

  var refreshToken =
	req.body && req.body['refresh_token'] ||
    req.query && req.query['refresh_token'] ||
    req.headers && req.headers['refresh_token'];
